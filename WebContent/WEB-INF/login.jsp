					...
					<TR>
						<td>
							<select id="roleName" name="roleName" class="input" style="margin-top: 15px;height: 24px">
								...
								<option value="1"  ${'1'==user.roleName?'selected':'' }>系统管理员</option>
								<option value="2"  ${'2'==user.roleName?'selected':'' }>销售主管</option>
								<option value="3"  ${'3'==user.roleName?'selected':'' }>客户经理</option>
								<option value="4"  ${'4'==user.roleName?'selected':'' }>高管</option>
							</select>
						</td>
					</TR>
				</TBODY>
